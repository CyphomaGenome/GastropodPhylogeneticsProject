...
#cd /mnt/c/Bioinformatics/Bioinformatics/GastropodPhylogeneticsProject/Li_et_al_simplified_replicate


#Run IQ-Tree with fast bootstraps
#iqtree2 -s Li_et_al_replicate.phy -bb 10000 -nt AUTO

###the next lines of code turn uncertainty into polytomies
my_tree <- read.tree("Li_et_al_replicate.phy.treefile")
my_tree
#Define threshold
threshold <- 60
threshold
...
final_tree
write.tree(my_tree, "Li_et_al_replicate60threshold.tre")
