...
Accession_list <- c("MG194428", "KT753575", "KT753614", "KT753591", "KT753567", "KT753537", "KT753638", "KT753646", "KT753588", "KT753622", "KT753609", "KT753574", "KT753608", "KT753612", "HQ834010", "KT753658", "HQ834002", "KT753572", "KT753570", "HQ834029", "KT753583")
Accession_list
...
MSA_Subset<-subseq(alignment_set, start = 52, end = 1783)
MSA_Subset
write.DNAStringSet(x = MSA_Subset, format = "phylip", filename = "Peristernia_18S.phy")

#Navigate to proper folder
#cd /mnt/c/Bioinformatics/Bioinformatics/GastropodPhylogeneticsProject/Peristernia_18s_rRNA

#Add iqtree to space
#export PATH="$PATH:/mnt/c/Bioinformatics/iqtree-2.2.2.7-Linux/bin"

#Run IQ-Tree with fast bootstraps
#iqtree2 -s Peristernia_18S.phy -bb 10000 -nt AUTO -wbt

###the next lines of code turn uncertainty into polytomies
my_tree <- read.tree("Peristernia_18S.phy.treefile")
my_tree
#Define threshold
threshold <- 60
threshold
...
final_tree
write.tree(my_tree, "Peristernia_18S.phy60threshold.tre")
