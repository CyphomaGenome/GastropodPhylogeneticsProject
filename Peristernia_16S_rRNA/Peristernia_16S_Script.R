...
Accession_list <- c("AB044267", "JQ950137", "KT753868", "KT753845", "KT753824", "KT753799", "AB044266", "JQ950145", "KT753880", "KT753887", "KT753842", "KT753874", "KT753879", "KT753863", "KT753830", "KT753862", "KT753892", "KT753866", "JQ950146", "JQ950147", "KY488730", "KY488731", "AB439793", "AB439767", "AB498791", "AB498789", "AB044262", "AB044271", "MW067268", "MW067275", "KY488776", "OZ238735", "OZ238676", "FM999132", "FM999131", "KT753895", "AB044273", "MH571402", "HQ833984", " KT753828", "KT753826", "JQ950140", "MW067239", "MN320437", "FM999124", "AB856401", "AB856380", "AB044268", "KY488916", "AB044259", "AB044269", "FM999128", "AB044261", "MW067286", "MW067284", "FN394060", "KT753839", "MW067250", "AB044256", "AB121037", "AB044263")
Accession_list
...
MSA_Subset<-subseq(alignment_set, start = 780, end = 1296)
MSA_Subset
write.DNAStringSet(x = MSA_Subset, format = "phylip", filename = "Peristernia_16S.phy")

#Navigate to proper folder
#cd /mnt/c/Bioinformatics/Bioinformatics/GastropodPhylogeneticsProject/Peristernia_16s_rRNA

#Add iqtree to space
#export PATH="$PATH:/mnt/c/Bioinformatics/iqtree-2.2.2.7-Linux/bin"

#Run IQ-Tree with fast bootstraps
#iqtree2 -s Peristernia_16S.phy -bb 10000 -nt AUTO -wbt

###the next lines of code turn uncertainty into polytomies
my_tree <- read.tree("Peristernia_16S.phy.treefile")
my_tree
#Define threshold
threshold <- 60
threshold
...
final_tree
write.tree(my_tree, "Peristernia_16S.phy60threshold.tre")
