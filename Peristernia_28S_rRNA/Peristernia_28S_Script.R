...
Accession_list <- c("MG194426", "KT753708", "KT753747", "KT753724", "KT753700", "KT753670", "JQ950167", "KT753771", "KT753779", "KT753721", "KT753755", "KT753767", "KT753742", "KT753707", "KT753741", "KT753788", "KT753745", "JQ950157", "JQ950190", "KY489125", "KY489126", "FJ710096", "FJ710101", "FJ710107", "MW067194", "MW067201", "KY489164", "MW067171",  "FM999153", "FM999152", "KT753791",  "MH571230", "KT753705", "KT753703", "JQ950154", "MN414053", "FM999148", "KY489176", "AB856268", "MW067203", "MW067188", "MW067211", "MW067209", "KT753716", "MW067178", "FJ710099")
Accession_list
...
MSA_Subset<-subseq(alignment_set, start = 91, end = 819)
MSA_Subset
write.DNAStringSet(x = MSA_Subset, format = "phylip", filename = "Peristernia_28S.phy")

#Navigate to proper folder
#cd /mnt/c/Bioinformatics/Bioinformatics/GastropodPhylogeneticsProject/Peristernia_28s_rRNA

#Add iqtree to space
#export PATH="$PATH:/mnt/c/Bioinformatics/iqtree-2.2.2.7-Linux/bin"

#Run IQ-Tree with fast bootstraps
#iqtree2 -s Peristernia_28S.phy -bb 10000 -nt AUTO -wbt

###the next lines of code turn uncertainty into polytomies
my_tree <- read.tree("Peristernia_28S.phy.treefile")
my_tree
#Define threshold
threshold <- 60
threshold
